-- Update the active_games view to include default logo_url
...
-- Update Chick-fil-A logos
UPDATE prizes 
SET logo_url = 'https://boemdxppyuspuhvgfzmb.supabase.co/storage/v1/object/public/logos/cfa-logo.png'
WHERE name ILIKE '%chick-fil-a%' 
   OR description ILIKE '%chick-fil-a%';

-- Update Starbucks logos
UPDATE prizes 
...
-- Update McDonald's logos
UPDATE prizes 
SET logo_url = 'https://boemdxppyuspuhvgfzmb.supabase.co/storage/v1/object/public/logos//mcdonalds-logo.png'
WHERE name ILIKE '%mcdonald%' 
   OR description ILIKE '%mcdonald%';

-- Update Target logos
UPDATE prizes 
SET logo_url = 'https://boemdxppyuspuhvgfzmb.supabase.co/storage/v1/object/public/logos//target-logo.png'
